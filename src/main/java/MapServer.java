...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        LinkedList<String> allPossibleaddresses = new LinkedList<>();
        String clean = GraphDB.cleanString(prefix).replaceAll(" ", "");
        Iterable<String> possiblephrases = graph.tries.subSet(clean, true, clean + "z", true);
        for (String s : possiblephrases) {
            allPossibleaddresses.add(graph.mappingAddresses.get(s));
        }
...
//[Shasta Rd & Queens Rd, Shasta Rd & Grizzly Peak Blvd, Shasta Rd & Miller Av, Shattuck Pl & Rose St, Shattuck & Adeline (UC Storage), Shattuck & Virginia, Shattuck Auto Collision Center, Shattuck Av & Allston Way, Shattuck Av & Cedar St, Shattuck Av & Delaware St, Shattuck Av & University Av, Shattuck Av & Virginia St, Shattuck Av & Vine St, Shattuck Av & Kittredge St, Shattuck Avenue United Methodist Church, Shattuck Avenue/ Lincoln Street, Shattuck Sq & Center St, Shattuck Square, Shattuck Cinemas, Shattuck Market, Shakespeare and Company Books, Shrimati's, s-Hertogenbosch, Sheltons School, Sheldon Marten Public Health Library, Shell, Shimizu, Shine Laundromat, Showers of Flowers]>
//[Shakespeare and Company Books, Shasta Rd & Grizzly Peak Blvd, Shasta Rd & Miller Av, Shasta Rd & Queens Rd, Shattuck & Adeline (UC Storage), Shattuck Auto Collision Center, Shattuck Av & Allston Way, Shattuck Av & Cedar St, Shattuck Av & Delaware St, Shattuck Avenue/ Lincoln Street, Shattuck Avenue United Methodist Church, Shattuck Av & Kittredge St, Shattuck Av & University Av, Shattuck Av & Vine St, Shattuck Av & Virginia St, Shattuck Cinemas, Shattuck Market, Shattuck Pl & Rose St, Shattuck Sq & Center St, Shattuck Square, Shattuck & Virginia, Sheldon Marten Public Health Library, Shell, Sheltons School, s-Hertogenbosch, Shimizu, Shine Laundromat, S. H. Kress Co. Store, Showers of Flowers, Shrimati's]>
        List<Map<String, Object>> allPossibleWords = new LinkedList<>();
        String clean = (GraphDB.cleanString(locationName)).replaceAll(" ","");
        Set<String> possiblephrases = graph.tries.subSet(clean, true, clean, true);
        for (String s : possiblephrases) {
            for (GraphDB.Vertex v : graph.locations.get(s)) {
                allPossibleWords.add(v.getTags());
            }
        }
